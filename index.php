...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row my-4">
        <div class="col-lg-8">
          <img class="img-fluid rounded" src="http://www.grasmickfarmsandfeedlots.com/data1/images/4.jpg" alt="">
        </div>
        <!-- /.col-lg-8 -->
        <div class="col-lg-4">
          <h1>Get the best price for your livestock!</h1>
          <p>Agri-Compare is a consolidated, central market hub for farmers and cattle dealers. A place where the most up to date price information is collected and analysed. </p>
          <a class="btn btn-primary btn-lg" href="martpage.php">Latest Beef Factory Prices</a>
        </div>
        <!-- /.col-md-4 -->
      </div>
      <!-- /.row -->
      ...
      <div class="card text-white bg-secondary my-4 text-center">
        <div class="card-body">
          <p class="text-white m-0">Whether it's making your yearly or daily trip to the cattle mart or beef factory, Agri-Compare will keep you up to date on the best prices available in each region of the country</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            <div class="card-body">
              <h2 class="card-title">Cattle Mart Sales</h2>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            <div class="card-body">
              <h2 class="card-title">Animal Disposal</h2>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; 2017 Agri-Compare.com</p>
      </div>
      <!-- /.container -->
    </footer>
